...
def _get_service(session: AsyncSession = Depends(get_db_session)) -> AdminService:
...
@router.patch("/products/{product_id}", response_model=ProductResponse,
              summary="Update product (name / deactivate)")
...
# subscription
@router.post("/companies/{company_id}/subscriptions",
...
@router.patch("/companies/{company_id}/subscriptions/{subscription_id}",
